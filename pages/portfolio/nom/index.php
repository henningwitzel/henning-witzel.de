...
<div class='image' 
data_image_1280='###basepath###img/header/placeholder-header-1280.jpg' 
data_image_1440='###basepath###img/header/placeholder-header-1440.jpg' 
data_image_1920='###basepath###img/header/placeholder-header-1920.jpg' 
data_image_800='###basepath###img/header/placeholder-header-800.jpg' id='header'></div>
<div class='text' id='background'>
  <div id='wrapper'>
    ...
    <a class="bottom-large" href="javascript:history.back()"><span style="font-family: 'Droid Sans'">← </span>Back to Portfolio</a>
      <br /><br /><br />          
      <h1>Omnichannel Manager</h1>
      <h4 class="grey bottom-large">A back-office tool to manage the day-to-day operations of a retailer</h4>
